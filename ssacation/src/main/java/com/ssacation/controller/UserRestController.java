package com.ssacation.controller;
...
import com.ssacation.model.service.UserService;
...
//	@Autowired
	...
	@ApiOperation(value = "{name}에 해당하는 사용자 정보를 반환한다.", response = User.class)
	public ResponseEntity<?> selectName(@PathVariable String name) {
		try {
